...
class MyRenderTexture2(val context: Context) : GLSurfaceView.Renderer {
...
//        close()
    ...
    fun drawCanvas(){
        ...
        val canvas1 = pictureRecorder.beginRecording(bounds)
        paint.color = Color.RED
//        canvas1?.clear(-1)
        canvas1?.drawRect(Rect.makeXYWH(500f,500f,500f,500f),paint)
        canvas1?.drawCircle(200f, 200f, 200f, paint)
        if (count>100) {
            canvas1?.drawCircle(500f, 500f, 200f, paint)
        }
        pickHolder?.close()
